...
const Rsslogin = () => {
 ...
 const login = async(data) =>{
  try{
    await AxiosApi.post('/student/loginrss',data).then((response)=>{
  ...
  return (
    ...
    <div className="flex flex-col items-center">
      <form action="" className="rounded-lg border border-white p-8" onSubmit={handleSubmit(login)}>
